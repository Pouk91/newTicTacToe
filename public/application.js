...
/***/ (function(module, exports, __webpack_require__) {
	...
	var tictactoeLogic = __webpack_require__(11);
	...
	var onUpdateMoves = function onUpdateMoves(getIndex, getValue) {
	  // console.log(data.game)
	  api.updateMoves(getIndex, getValue) // try data.game instead of data
	  .done(ui.updateMovesSuccess).fail(ui.updateMovesFailure);
	};
	...
	var cellClick = function cellClick(event) {
	  ...
	  var getIndex = $(this).data('position');
	  var getValue = currentPlayer;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateGame = __webpack_require__(12).updateGame;
	// const events = require('./events.js')

	var totalClicks = 0;

	var isNoWinner = function isNoWinner() {
	  totalClicks++;
	...
	var isWinnerX = function isWinnerX() {
	...
	var isWinnerO = function isWinnerO() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateMoves = function updateMoves(getIndex, getValue) {
	  return $.ajax({
	    url: config.apiOrigin + '/games/' + store.game.id,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateMovesSuccess = function updateMovesSuccess(data) {
	  console.log(data);
	};

	var updateMovesFailure = function updateMovesFailure(data) {
	  console.log(data);
	};
	...
	module.exports = {
	  ...
	  updateMovesSuccess: updateMovesSuccess,
	  updateMovesFailure: updateMovesFailure,
